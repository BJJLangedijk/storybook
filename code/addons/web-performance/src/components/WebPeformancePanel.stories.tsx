...
const Template = (
  args: Pick<
    WebPerformanceContextStore,
    'results' | 'error' | 'status' | 'discrepancy' | 'selectedItems'
  > &
    Pick<Partial<WebPerformanceContextStore>, 'parameters'>
) => (
  <WebPerformanceContext.Provider value={{ ...context, ...args }}>
