export const ADDON_ID = 'storybook/web-performance';
export const PANEL_ID = `${ADDON_ID}/panel`;
export const PARAM_KEY = `web-performance`;
...
export const TEST_PROVIDER_ID = 'storybook/addon-web-performance/test-provider';
